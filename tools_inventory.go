...
func registeredToolInventory() []ToolInventoryEntry {
	return []ToolInventoryEntry{
		...
		{Name: "dependency_tree", Kind: ToolKindLSPBacked, Mutating: false, Critical: false},
		...
		{Name: "graph_query", Kind: ToolKindLSPBacked, Mutating: false, Critical: false},
		...
		{Name: "get_node_at_position", Kind: ToolKindLocalOnly, Mutating: false, Critical: false},
		{Name: "get_node_types", Kind: ToolKindLocalOnly, Mutating: false, Critical: false},
		{Name: "onboarding", Kind: ToolKindLocalOnly, Mutating: false, Critical: false},
		{Name: "memory_write", Kind: ToolKindLocalOnly, Mutating: true, Critical: false},
		{Name: "write_memory", Kind: ToolKindLocalOnly, Mutating: true, Critical: false},
		{Name: "memory_read", Kind: ToolKindLocalOnly, Mutating: false, Critical: false},
		{Name: "read_memory", Kind: ToolKindLocalOnly, Mutating: false, Critical: false},
		{Name: "memory_list", Kind: ToolKindLocalOnly, Mutating: false, Critical: false},
